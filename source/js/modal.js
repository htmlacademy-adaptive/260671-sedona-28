let modalErrorWindow = document.querySelector('.modal-container-error');
let modalSuccessWindow = document.querySelector('.modal-container-success');
let closeErrorButton = document.querySelector('.modal-container-error__btn');
let closeSuccessButton = document.querySelector('.modal-container-success__btn');
